  ...
  btn.addEventListener("click", function () {
    if (document.querySelector("input").value.length == 0) {
      ...
      document.querySelector("#right-box").innerHTML += `<div class="card">
         <div class="photo"><img src="${document.querySelector("#url2").value
        }" alt=""></div>
         <p class="para" id="p1">Name: ${document.querySelector("#name").value
        }</p>
         <p class="para" id="p2">Email:${document.querySelector("#email").value
        }</p>
         <p class="para" id="p3">Website: ${document.querySelector("#url").value
        }</p>
         <p class="para" id="p4">Gender:  ${result}</p>
         <p class="para" id="p5">Skills:  ${document.querySelector("#enroll").value
        }</p>
     </div>`;
